...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { alias: @gallery.alias, description: @gallery.description, link: @gallery.link, teaser: @gallery.teaser, title: @gallery.title }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { alias: @gallery.alias, description: @gallery.description, link: @gallery.link, teaser: @gallery.teaser, title: @gallery.title }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
